      ...
      @include('themelayout.sidebar')
       ...
       @include('themelayout.header')
           <!-- sa-app__body -->
                        ...
                        <div class="container">
                            <div class="py-5">
                                <div class="row g-4 align-items-center">
                                    ...
                                    @if(Auth::user()->role ==1)
                                    <div class="col-auto d-flex"><a href="{{route('add.Book')}}" class="btn btn-primary">Add Book</a></div>
                                    @else
                                    @endif
                                </div>
                            </div>
                            <div class="card">
                                ...
                                @endif
                                <div class="p-4">
                                    <input type="text" placeholder="Start typing to search for Books"
                                ...
                                <table class="sa-datatables-init" data-order='[[ 1, "desc" ]]' data-sa-search-input="#table-search">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="min-w-15x">Book title</th>
                                            <th>Rack</th>
                                            <th>Author</th>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="category-context-menu-0">
                                                        <li><a class="dropdown-item" style="cursor: pointer;" onclick="confirmEdit({{$Book->id}})" >Edit</a></li>
                                                        <li><a class="dropdown-item" style="cursor: pointer;">Duplicate</a></li>  
                                                        <li><hr class="dropdown-divider" /></li>
                                                        <li><a class="dropdown-item text-danger" style="cursor: pointer;" onclick="confirmDelete({{$Book->id}})" >Delete</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
                ...
                <form action="{{route('edit.Book')}}" method="post" id="editform">
                    @csrf
